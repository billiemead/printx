...
class BroSolutions_CustomOption_Model_Product_Option_Type_QuantityBreaks extends Magekart_CustomOptions_Model_Catalog_Product_Option_Type_Select
{
        ...
        $result = 0;                
            ...
            foreach(explode(',', $optionValue) as $value) {
                if ($opValue = $option->getValueById($value)) {                    
                    ...
                    $this->getFinishingData()->setQty($opValue->getQty());
