...
class BroSolutions_CustomOption_Model_Product_Option_Type_NumberOfPages extends Magekart_CustomOptions_Model_Catalog_Product_Option_Type_Select
{
        ...
        if (!$this->_isSingleSelection()) {
            foreach(explode(',', $optionValue) as $value) {
                if ($opValue = $option->getValueById($value)) {         
                    ...
                    $this->getFinishingData()->setPages($opValue->getPages());
