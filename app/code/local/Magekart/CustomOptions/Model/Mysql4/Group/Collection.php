...
class Magekart_CustomOptions_Model_Mysql4_Group_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
	...
	$this->getSelect()->where('main_table.is_active = ?', Magekart_CustomOptions_Helper_Data::STATUS_VISIBLE);
        return $this;
    }
