...
class Magekart_Adminhtml_Customoptions_OptionsController extends Mage_Adminhtml_Controller_Action {
    ...
    public function editAction() {
        ...
        if ($model->getId() || $id == 0) {
            ...
            ->_setActiveMenu('catalog/customoptions')
            ->_addBreadcrumb($this->__('APO'), $this->__('Manage Templates'))
            ->_addContent($this->getLayout()->createBlock('magekart/customoptions_options_edit'))
            ->_addLeft($this->getLayout()->createBlock('adminhtml/store_switcher'))
            ->_addLeft($this->getLayout()->createBlock('magekart/customoptions_options_edit_tabs'));
                    ...
                    if (isset($option['values']) && is_array($option['values'])) {
                        ...
                        foreach ($option['values'] as $k => $value) {
                            if (!isset($value['is_delete']) || $value['is_delete']!=1) {
                                ...
                                if (isset($value['sku'])) $value['sku'] = trim($value['sku']);
...
//                    exit;
    ...
    public function productGridAction() {
        ...
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('magekart/customoptions_options_edit_tab_product')->toHtml()
        );
    }
